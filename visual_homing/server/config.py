...
class Config:
    ...
    # Keyframe Settings
    keyframe_interval_m: float = 3.0  # Push keyframe every 2 meters
    keyframe_interval_s: float = 5.0  # OR every 3 seconds (whichever first)

    # Homing Settings
    waypoint_threshold_m: float = 1  # Pop keyframe when within 0.8m
    ...
    fixed_flight_velocity: float = 0.6  # Slow, steady velocity for stable flight
    ...
    command_duration_s: float = 1.6         # How long each command executes on drone
